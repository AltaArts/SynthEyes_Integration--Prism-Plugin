...
> [!CAUTION]  
> NOTE: the script file under the Scripts->Prism->PrismUtils is not meant to be used by the user.  This exists to allow the Prism integration to set certain settings in SynthEyes during a publish (see [**Scene Export**](Export_Scene.md)).
