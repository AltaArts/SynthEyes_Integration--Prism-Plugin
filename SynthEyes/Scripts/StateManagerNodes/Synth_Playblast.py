...
class Synth_PlayblastClass(object):
    ...
    def loadDefaults(self):
        ...
        self.chb_include_Items.setChecked(True)
        self.chb_include_Grid.setChecked(True)
    ...
    def connectEvents(self):
        ...
        self.chb_include_Depth.stateChanged.connect(self.stateManager.saveStatesToScene)
